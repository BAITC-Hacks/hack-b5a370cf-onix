...
| `components/CityMap3D.tsx` | 3D-карта районов на чистом SVG (без внешних библиотек и интернета) |
...
| Визуализация изменений показателей районов | ✅ Схематичная 3D-карта Астаны (изометрия, реальное взаимное расположение районов и р. Есиль): высота района равна баллу или выбранному показателю, анимация при изменении плана, пунктир «до мер», метки показателей < 40. Плюс графики «до/после», вклад мер и тепловая таблица |
