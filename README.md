...
11. **Городское событие:** выберите «Сокращение трансферта». Бюджет станет 85, набор из шага 3 (стоимость 95) станет невалидным, валидатор покажет причину. Выберите «Прорыв теплотрассы в Алматы»: ЖКХ Алматы упадёт до 38 (ниже 40, штраф), и AI-анализ предложит заменить M5 на M14 (+1.44).
...
| `lib/agent.ts` | AI-советник: OpenAI tool calling поверх движка, до 6 шагов, проверка чисел в ответе |
